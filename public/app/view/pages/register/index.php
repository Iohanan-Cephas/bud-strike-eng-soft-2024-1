        ...
        <div class="login-container" >
            <form class="login-form" action="">
                ...
                <div class="user-password" id="password">
                    ...
                    <input type="password" class="password" id="password-input" placeholder="senha" type="text">
                </div>
                <div class="user-password" id="password-confirm">
                  <img src="../../assets/lock.svg" alt="">
                  <input type="password" class="password" id="password-input-confirm" placeholder="confirmar senha" type="text">
              </div>
              <div id="terms" >
